...
const int POINTS_QUANTITY = 16;
const float RADIUS_OUT = 0.7f;
const float RADIUS_IN = 0.5f;
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //                |              |                    |                |
        //                V              V                    V                V
        glDrawElements(GL_TRIANGLE_STRIP, POINTS_QUANTITY * 2 + 2, GL_UNSIGNED_BYTE, 0);
...
GLuint buildTriangles()
{
    ...
    //
    GLfloat NDC_coefficients[POINTS_QUANTITY * 2 * 4] = {0.0f};
    int i;
    double theta;
    ...
    GLfloat color_coefficients[POINTS_QUANTITY * 2 * 4] = {0.0f}; // Inicializa todos com 0.0f por padrão
    ...
    //
    GLubyte indices[POINTS_QUANTITY * 2 + 2]; // GLubyte: valores entre 0 e 255 (8 bits sem sinal).
    for(int i=0; i < POINTS_QUANTITY * 2; i++){
        indices[i] = i;
    }
    indices[POINTS_QUANTITY * 2] = 0;
    indices[POINTS_QUANTITY * 2 + 1] = 1;
